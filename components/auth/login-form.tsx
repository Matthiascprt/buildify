            ...
            <form onSubmit={handleForgotPassword}>
              ...
              <div className="mt-6 space-y-3">
                <button
                  ...
                  className="w-full h-11 px-4 bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium rounded-lg transition-all disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-2"
                >
                  {resetLoading ? (
                    <>
                ...
                <button
                  ...
                  className="w-full h-11 px-4 bg-zinc-100 hover:bg-zinc-200 text-zinc-700 text-sm font-medium rounded-lg transition-all"
                >
                  Retour
                </button>
              </div>
